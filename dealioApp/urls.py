...
urlpatterns = [
    ...
    url(r'^autopop/$', views.autopop, name='autopop'),
    url(r'^about$', views.about, name='about'),
    url(r'^restaurants/$', views.restaurants, name='restaurants'),
    url(r'^compute_restaurants/$', views.compute_restaurants, name='urlname'),
    ...
    url(r'^share_promo/(?P<promo_id>\d+)/(?P<restaurant_id>\d+)/$', views.share_promo, name='share_promo'),
    ...
    url(r'^promotion_review/(?P<restaurant_id>\d+)/(?P<promo_id>\d+)/$', views.new_review, name='promotion-review'),
